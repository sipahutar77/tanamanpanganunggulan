...
map.getView().fit([109.998754, -8.233803, 110.875818, -7.535534], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Klaster Potensi Kecamatan di Provinsi DI Yogyakarta</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_KlasterPotensiYogyakarta_5,
    colName: 'WADMKC',
    zoom: 10,
    collapsed: true,
    map: map
