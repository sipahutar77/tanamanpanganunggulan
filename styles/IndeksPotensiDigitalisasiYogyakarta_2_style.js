...
var style_IndeksPotensiDigitalisasiYogyakarta_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("digitalisasi_indeks_digital");
    ...
    if (value >= 0.175000 && value <= 0.361000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.361000 && value <= 0.492000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.492000 && value <= 0.658000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.658000 && value <= 0.850000) {
            style = [ new ol.style.Style({
